...
const chart = d3.select('.row')
  .select('.column1')
  .select(".card").select("#chart")
  .select("svg")
  .attr("width", w + margin.left + margin.right)
  .attr("height", h + margin.top + margin.bottom)
  .append("g") // groups all the elements in the chart
  .attr("transform", `translate(${margin.right},${margin.left*5})scale(.7)`);
...
d3.json("data.json").then((data) => {
          ...
          chart
              ...
              .text("Comparing Covid Fatalities to Vaccination");
          /************************************************************************
                                      //set the Y-axis
          ...
          ***********************************************************************/
          ...
          yAxisGroup.append("text")
              .text("Fatality Rate(%)")
              .attr("y", h / 2 - 10)
              .attr("transform", "translate(-340,300) rotate(270)")
              .style("fill", "blue")
              .attr("font-size", 20)
              .attr("text-anchor", "middle");
          ...
          ***********************************************************************/
          const maxX = d3.max(data.map((d) => (d.T_Vaccinations)));
...
***********************************************************************/
      ...
      .data(data)
        ...
        .attr('cx', (d, i) => xScale(d.T_Vaccinations))
